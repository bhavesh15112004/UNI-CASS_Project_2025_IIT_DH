...
N 510 -220 630 -220 {lab=ota_vinp}
N 510 -100 630 -100 {lab=ota_vinm}
N 420 -220 450 -220 {lab=inp}
N 420 -100 450 -100 {lab=inm}
...
"}
=======
>>>>>>> 2da487fbbdee83046c1e1ecca6ff10998b2bd29e
...
C {/home/prabhas/unic-cass-example/UNI-CASS_Project/final_Design_file/Differntial_ended_symbol_making.sym} -320 -160 1 0 {name=x2}
...
C {lab_pin.sym} -70 120 1 0 {name=p1 sig_type=std_logic lab=inp
}
C {lab_pin.sym} 40 120 1 0 {name=p3 sig_type=std_logic lab=inm
}
...
C {sg13g2_pr/cap_cmim.sym} 480 -220 1 1 {name=C3
model=cap_cmim
w=7e-6
l=7e-6
m=14
spiceprefix=X}
C {sg13g2_pr/cap_cmim.sym} 480 -100 1 1 {name=C4
model=cap_cmim
w=7e-6
l=7e-6
m=14
spiceprefix=X}
C {sg13g2_pr/cap_cmim.sym} 660 -220 1 1 {name=C5
model=cap_cmim
w=6e-6
l=6e-6
m=1
spiceprefix=X}
C {sg13g2_pr/cap_cmim.sym} 660 -100 1 1 {name=C6
model=cap_cmim
w=6e-6
l=6e-6
m=1
spiceprefix=X}
C {lab_pin.sym} 580 -220 1 0 {name=p18 sig_type=std_logic lab=ota_vinp
}
C {lab_pin.sym} 580 -100 1 0 {name=p19 sig_type=std_logic lab=ota_vinm
}
C {lab_pin.sym} 690 -100 2 0 {name=p20 sig_type=std_logic lab=ota_vop}
C {lab_pin.sym} 690 -220 2 0 {name=p21 sig_type=std_logic lab=ota_vom}
C {lab_pin.sym} 420 -220 1 0 {name=p22 sig_type=std_logic lab=inp
}
C {lab_pin.sym} 430 -100 1 0 {name=p23 sig_type=std_logic lab=inm
}
C {vsource.sym} -70 150 0 0 {name=V6 value="sin(0.8 5m 1k)" savecurrent=false}
C {devices/code_shown.sym} -680 260 0 0 {name=NGSPICE only_toplevel=true 
value="
